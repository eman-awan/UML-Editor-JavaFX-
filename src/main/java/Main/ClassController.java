...
public class ClassController {
    ...
    public void onAddClassDiagramClick() {
        UMLObject classDiagram = new ClassObject();
        addToCanvas(classDiagram, 100, 100);
    }
...
//    }
    ...
    public void onAddInterfaceDiagramClick() {
        UMLObject interfaceDiagram = new InterfaceObject();
        addToCanvas(interfaceDiagram,100, 200);
    }
...
//            ToastMessage.showNegativeToast(canvas, "Failed to Saved Jpeg", 3);
//        }
//    }
